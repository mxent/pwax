...
class ModulePreloadTest extends TestCase
{
    ...
    {
        // The two reading different keys fails silently: a missing resource hint is a
        // lost round trip and never an error, and a test that sets both keys passes
        // against a reader that has neither.
        //
