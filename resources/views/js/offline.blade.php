{{--
    ...
    A Blade view, rather than forty lines of HTML inside a JavaScript string inside the
    worker. It picks up the application's language and direction, and can be published on
    its own:
