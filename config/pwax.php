...
return [
    ...
    */
    ...
    | component this catalog lists, and one it does not name renders nothing.
    |
    |     <PwaxJson :json="doc" />
    |
    ...
    |             the description and prop types a generator needs. Those are
    |             prompt material, not a runtime gate — see the note below.
