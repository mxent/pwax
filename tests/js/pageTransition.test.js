...
describe('the page stylesheet follows the page', () => {
    ...
    it('replaces the previous page stylesheet rather than keeping it', async () => {
        ...
        // The key has to name the page. A constant `pwax:page` would let the second
        // acquire find the first page's entry, increment its count and return — every
        // page after the first rendered with the first page's rules and none of its own.
