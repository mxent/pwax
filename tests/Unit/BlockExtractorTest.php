...
class BlockExtractorTest extends TestCase
{
    ...
    /**
     * Taking the first `<template>` and the last `</template>` breaks as soon as a
     * component uses Vue's own structural templates.
     */
    ...
    /**
     * Matching every `<link href>` would hand the manifest link and the favicons to the
     * client as component stylesheets.
     */
