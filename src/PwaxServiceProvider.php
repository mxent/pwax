...
class PwaxServiceProvider extends ServiceProvider
{
     ...
     * the view runs, not when Blade compiles it. Returning a literal string would freeze
     * the resolved URL into `storage/framework/views` — so changing `route_prefix`, or
     * running `view:cache` in a build step with no routes loaded, would produce imports
    ...
    protected function bootPublishing(): void
    {
        ...
        // The offline document, not the worker. The worker is a built bundle, and the
