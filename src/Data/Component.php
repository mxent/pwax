...
final class Component implements Arrayable, Jsonable, JsonSerializable
{
     ...
     *
     * `style` is the component's own CSS and `styles` the hrefs it links; `script` is its
     * own JavaScript and `scripts` the srcs it loads. The singular/plural pairing reads as
     * a near-collision and is worth the wince: `page.js` attaches all four, and naming the
     * inline one `inlineStyle` would leave the pair describing the same thing in two
