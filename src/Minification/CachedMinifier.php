 ...
 * the most expensive thing Pwax does per request. In 1.x it ran on every single
 * component fetch. Caching on content means a component pays for minification once,
 * and cache entries for edited components fall out naturally because the digest changes.
 */
