...
describe('compiled render functions run on the vendored runtime build', () => {
     ...
     * enough to cross the threshold — and, because precompiling is per component and an
     * incomplete store falls back to the browser's compiler, changed it away from what the
     * component beside it rendered.
     */
